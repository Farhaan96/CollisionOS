...
describe('VirtualizedDataTable', () => {
  ...
  test('handles column sorting', () => {
    ...
    renderWithTheme(<VirtualizedDataTable {...defaultProps} onSort={onSort} />);
  ...
  test('handles row click', () => {
    ...
    renderWithTheme(
      <VirtualizedDataTable {...defaultProps} onRowClick={onRowClick} />
    );
  ...
  test('handles sticky columns', () => {
    renderWithTheme(
      <VirtualizedDataTable {...defaultProps} stickyColumns={['id', 'name']} />
    );
  ...
  test('handles empty data state', () => {
    renderWithTheme(<VirtualizedDataTable {...defaultProps} data={[]} />);
  ...
  test('applies correct row height', () => {
    renderWithTheme(<VirtualizedDataTable {...defaultProps} rowHeight={80} />);
  ...
  test('handles large datasets efficiently', () => {
    ...
    renderWithTheme(
      <VirtualizedDataTable {...defaultProps} data={largeData} />
    );
