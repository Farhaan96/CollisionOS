...
import CircularProgress, {
  CircularRing,
  MultiRingProgress,
} from '../../../../src/components/Charts/CircularProgress';
...
describe('CircularProgress', () => {
  ...
  describe('CircularProgress - Single Ring', () => {
    ...
    it('displays custom value and percentage', () => {
      renderWithTheme(<CircularProgress value={50} maxValue={100} />);
    ...
    it('shows value instead of percentage when showPercentage is false', () => {
      renderWithTheme(
        <CircularProgress value={75} maxValue={100} showPercentage={false} />
      );
    ...
    it('displays custom label', () => {
      renderWithTheme(<CircularProgress value={80} label='Completion Rate' />);
    ...
    it('handles click events', () => {
      ...
      renderWithTheme(<CircularProgress value={50} onClick={handleClick} />);
    ...
    it('displays both value and percentage when showValue is true', () => {
      renderWithTheme(
        <CircularProgress value={75} maxValue={100} showValue={true} />
      );
  ...
  describe('CircularProgress - Multi Ring Variant', () => {
    ...
    it('renders multi-ring variant', () => {
      renderWithTheme(<CircularProgress variant='multi' rings={mockRings} />);
  ...
  describe('CircularRing Component', () => {
    it('renders basic ring', () => {
      renderWithTheme(<CircularRing value={60} maxValue={100} radius={50} />);
    ...
    it('handles different stroke widths', () => {
      renderWithTheme(<CircularRing value={60} strokeWidth={12} />);
    ...
    it('applies custom colors', () => {
      ...
      renderWithTheme(<CircularRing value={60} color={customColor} />);
    ...
    it('renders with gradient', () => {
      renderWithTheme(<CircularRing value={60} gradient={true} />);
    ...
    it('handles animation props', () => {
      renderWithTheme(
        <CircularRing value={60} animated={true} duration={1000} />
      );
  ...
  describe('CircularProgress - Different Thickness', () => {
    it('applies thin thickness', () => {
      renderWithTheme(<CircularProgress value={50} thickness='thin' />);

      expect(screen.getByText('50%')).toBeInTheDocument();
    });

    it('applies thick thickness', () => {
      renderWithTheme(<CircularProgress value={50} thickness='thick' />);
  ...
  describe('CircularProgress - Edge Cases', () => {
    it('handles zero value', () => {
      renderWithTheme(<CircularProgress value={0} maxValue={100} />);

      expect(screen.getByText('0%')).toBeInTheDocument();
    });

    it('handles value greater than max', () => {
      renderWithTheme(<CircularProgress value={120} maxValue={100} />);

      expect(screen.getByText('100%')).toBeInTheDocument(); // Should be clamped to 100%
    });

    it('handles negative value', () => {
      renderWithTheme(<CircularProgress value={-20} maxValue={100} />);
    ...
    it('handles custom center content', () => {
      ...
      renderWithTheme(
        <CircularProgress value={75} centerContent={customContent} />
      );
    ...
    it('handles different line caps', () => {
      renderWithTheme(<CircularProgress value={50} lineCap='square' />);

      expect(screen.getByText('50%')).toBeInTheDocument();
    });

    it('enables glow effect', () => {
      renderWithTheme(<CircularProgress value={50} glow={true} />);
  ...
  describe('CircularProgress - Accessibility', () => {
    it('supports tooltip', () => {
      renderWithTheme(
        <CircularProgress value={75} tooltip='Progress: 75% complete' />
      );
