...
const TEST_USERS = {
  ...
  estimator: { username: 'estimator', password: 'estimator123', role: 'estimator' }
};
...
test.describe('CollisionOS End-to-End Workflows', () => {
  ...
  test.describe('Authentication & Login', () => {
    ...
    test('should login successfully with admin credentials', async ({ page }) => {
      ...
      await page.fill('input[placeholder="admin123"]', TEST_USERS.admin.password);
  ...
  test.describe('Customer Management', () => {
    ...
    test('should search customers', async ({ page }) => {
      // Find search input
      const searchInput = page.locator('input[placeholder*="search" i], input[placeholder*="customer" i]');
  ...
  test.describe('Job Management', () => {
    ...
    test('should display production board with seeded jobs', async ({ page }) => {
    ...
    test('should create new job', async ({ page }) => {
      ...
      // Select customer
      await page.selectOption('select[name="customerId"]', SEEDED_DATA.customerIds[0]);
    ...
    test('should filter jobs by status', async ({ page }) => {
      ...
      const statusFilter = page.locator('select[name="statusFilter"], button:has-text("Filter")');
  ...
  test.describe('Parts Management', () => {
    ...
    test('should display parts management with seeded data', async ({ page }) => {
