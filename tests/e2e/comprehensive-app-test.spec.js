...
test.describe('CollisionOS Comprehensive Application Test', () => {
  ...
  test('should test every clickable element and navigation', async ({
    page,
  }) => {
    ...
    const signInButton = page.locator(
      'button:has-text("Sign In to CollisionOS")'
    );
    ...
    await expect(
      page.locator('text=Password reset feature coming soon')
    ).toBeVisible();
    ...
    await expect(
      page.locator('text=CollisionOS Dashboard').first()
    ).toBeVisible();
  ...
  async function testPageSpecificElements(page, route) {
    switch (route) {
      ...
      case '/production':
        ...
        await expect(
          page.locator('text=Production Board').first()
        ).toBeVisible();
      ...
      case '/customers':
        ...
        await expect(
          page.locator('text=Customer Management').first()
        ).toBeVisible();
      ...
      case '/bms-import':
        ...
        await expect(
          page.locator('text=BMS File Import').first()
        ).toBeVisible();
