...
async function main() {
  ...
  console.log(`   Port 3001 (Backend):  ${port3001 ? '✅ Available' : '❌ In Use'}`);
  ...
  console.log(`   Frontend (3000): ${frontendResult.success ? '✅ Running' : '❌ Not Running'}`);
  console.log(`   Backend (3001):  ${apiResult.success ? '✅ Running' : '❌ Not Running'}`);
