  ...
  extractThemeColors(theme) {
    ...
    if (theme.custom) {
      ...
      if (theme.custom.text) {
        ...
        colors.customTextSecondary = this.parseColor(
...
export const globalThemeTransition = new ThemeTransition(
  themeTransitionPresets.smooth
);
...
export const themeTransitionHelpers = {
  ...
  updateMetaTags(theme) {
    ...
    metaStatusBar.content =
      theme.palette?.mode === 'dark' ? 'black-translucent' : 'default';
