...
export const useTheme = () => {
  ...
  const switchThemeEnhanced = useCallback(
  ...
  const toggleThemeEnhanced = useCallback(
    (options = {}) => {
      if (!contextTheme) return;
  ...
  if (!contextTheme) {
    console.warn(
      'useTheme must be used within a ThemeProvider. Using fallback theme context.'
    );
    ...
    return {
      ...
      switchTheme: () =>
        console.warn('Theme switching not available without ThemeProvider'),
      toggleTheme: () =>
        console.warn('Theme toggling not available without ThemeProvider'),
      themeConfigs: {},
      getActiveTheme: () => muiTheme.palette.mode || 'light',
      prefersReducedMotion,
      switchThemeEnhanced: () =>
        console.warn(
          'Enhanced theme switching not available without ThemeProvider'
        ),
      toggleThemeEnhanced: () =>
        console.warn(
          'Enhanced theme toggling not available without ThemeProvider'
        ),
      themeMetrics: {},
      customThemeManager: {},
      themeScheduling: {},
