    ...
    <Container maxWidth='xl' sx={{ py: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant='subtitle1' color='textSecondary'>
          Advanced Vehicle Identification Number decoding with NHTSA API
          integration
        </Typography>
      </Box>
        ...
        <Alert severity='info' icon={<InfoIcon />}>
          ...
          <Typography component='div' variant='body2'>
            ...
            <ul style={{ margin: '8px 0', paddingLeft: '20px' }}>
              <li>
                <code>POST /api/vehicles/validate-vin</code> - Validate VIN
                format
              </li>
              <li>
                <code>POST /api/vehicles/decode-vin</code> - Decode single VIN
              </li>
              <li>
                <code>POST /api/vehicles/batch-decode</code> - Decode multiple
                VINs
              </li>
              <li>
                <code>GET /api/vehicles</code> - List vehicles with filtering
              </li>
              <li>
                <code>POST /api/vehicles</code> - Create vehicle with
                auto-decode
              </li>
            </ul>
          </Typography>
          <Typography variant='body2' sx={{ mt: 1 }}>
            <strong>Features:</strong> NHTSA API integration, local fallback,
            caching, rate limiting (100 requests per 15 minutes)
          </Typography>
        </Alert>
      </Box>
    </Container>
