  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const validCredentials = [
        ...
        { user: 'manager', pass: 'manager123', role: 'manager', firstName: 'Manager' },
        { user: 'estimator', pass: 'estimator123', role: 'estimator', firstName: 'Estimator' }
      ];
      ...
      if (credential) {
        ...
        if (rememberMe) {
          localStorage.setItem('collisionos_remembered_user', JSON.stringify({
