...
const CustomerSatisfactionWidget = ({ period = 'weekly', expanded = false }) => {
  ...
  useEffect(() => {
    ...
    const generateSatisfactionData = () => {
      ...
      setSatisfactionData({
        ...
        averageRating,
        previousRating,
        change: ((averageRating - previousRating) / previousRating * 100).toFixed(1),
        npsScore,
        responseRate,
      ...
      // Rating distribution
      const distribution = [
        { rating: 5, count: 58, percentage: 46, color: theme.palette.success.main },
        { rating: 4, count: 42, percentage: 33, color: theme.palette.info.main },
        { rating: 3, count: 18, percentage: 14, color: theme.palette.warning.main },
      ...
      const reviews = [
        {
          ...
          customer: 'John Smith',
          rating: 5,
          comment: 'Excellent service! My car looks brand new. The team was professional and kept me updated throughout the process.',
          date: '2 days ago',
          jobNumber: 'JOB-001',
        ...
        },
        {
          ...
          rating: 4,
          comment: 'Good work overall. The repair quality is great, though it took a bit longer than expected.',
          date: '3 days ago',
          jobNumber: 'JOB-012',
          category: 'Paint Work'
        },
        {
          ...
          customer: 'Mike Davis',
          rating: 5,
          comment: 'Outstanding customer service and attention to detail. Highly recommend this shop!',
          date: '5 days ago',
          jobNumber: 'JOB-008',
        ...
        },
        {
          ...
          rating: 3,
          comment: 'Average experience. The work was done correctly but communication could be better.',
          date: '1 week ago',
          jobNumber: 'JOB-005',
          category: 'Mechanical'
        },
        {
          ...
          rating: 5,
          comment: 'Perfect job! Fast, efficient, and great customer service. Will definitely return.',
          date: '1 week ago',
          jobNumber: 'JOB-003',
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                <Rating 
                  ...
                  readOnly 
                  size="small"
                  sx={{ '& .MuiRating-iconFilled': { color: getSentimentColor(review.rating) } }}
                />
          ...
          {payload.map((entry, index) => (
            <Box key={index} sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 0.5 }}>
              ...
              <Typography variant="body2" sx={{ fontSize: '0.75rem' }}>
                {entry.name}: {entry.value}{entry.name === 'rating' ? '/5' : ''}
              </Typography>
            </Box>
          ))}
        </Card>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          <Button
            ...
            onClick={() => setSelectedView(
              selectedView === 'overview' ? 'reviews' : 
              selectedView === 'reviews' ? 'trends' : 'overview'
            )}
            sx={{ minWidth: 120 }}
          >
            {selectedView === 'overview' ? 'Overview' : 
             selectedView === 'reviews' ? 'Reviews' : 'Trends'}
          </Button>
                  ...
                  <Card sx={{ p: 3, ...getGlassStyles('default', mode), height: '100%' }}>
                    ...
                    <Stack spacing={2}>
                      {sentimentBreakdown.map((item) => (
                        <Box key={item.rating} sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                          <Avatar 
                            sx={{ 
                              bgcolor: item.color,
                              width: 32,
