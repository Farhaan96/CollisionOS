...
const AlertsWidget = ({ expanded = false }) => {
  ...
  useEffect(() => {
    ...
    const generateAlerts = () => {
      const mockAlerts = [
        {
          ...
          message: 'Bay 3 has been idle for 2+ hours. Vehicle JOB-045 requires immediate attention.',
          details: 'Customer John Smith is waiting for pickup. ETA was 2 hours ago. Technician Mike needs parts approval.',
        ...
        },
        {
          ...
          details: 'Bumper covers (2 units), Headlight assembly (1 unit), and Paint primer (500ml) need immediate reordering.',
        ...
        },
        {
          ...
          details: 'Both JOB-048 and JOB-052 are scheduled for the same time slot. Please reschedule one appointment.',
        ...
        },
        {
          ...
          details: 'Order #PO-2024-156 from AutoParts Plus will arrive tomorrow instead of today due to weather conditions.',
        ...
        },
        {
          ...
          details: 'AllState Insurance claim #CLM-789456 for $4,250 is now 35 days overdue. Follow-up required.',
        ...
        },
        {
          ...
          details: 'Current week hours: 38/40. Scheduled hours today: 6. Consider adjusting schedule to avoid overtime.',
        ...
        },
        {
          ...
          details: 'Vehicle ready for customer pickup. All quality standards met. Customer notification sent.',
        ...
        },
        {
          ...
          details: 'New features include enhanced reporting, improved scheduling, and bug fixes. Update during off-hours recommended.',
      ...
      mockAlerts.sort((a, b) => {
        const priorityDiff = alertConfig[a.type].priority - alertConfig[b.type].priority;
        ...
        >
          <CardContent sx={{ p: 2, pb: isExpanded ? 2 : '16px !important' }}>
            ...
            <Collapse in={isExpanded} timeout={300}>
              <Box sx={{ mt: 2, pt: 2, borderTop: `1px solid ${config.color}30` }}>
                <Typography 
                  variant="body2" 
                  sx={{ 
                    fontSize: '0.8rem',
        ...
        <Stack direction="row" spacing={1} sx={{ flexWrap: 'wrap', gap: 1 }}>
          {[
            ...
            <Button
              ...
              size="small"
              startIcon={filter.key !== 'all' ? alertConfig[filter.key]?.icon : <FilterList />}
              ...
              sx={{
                ...
                py: 0.5,
                minWidth: 'auto',
                ...(selectedFilter === filter.key && filter.key !== 'all' && {
      ...
      <Box sx={{ flex: 1, overflow: 'auto', pr: 1 }}>
        <AnimatePresence>
          {filteredAlerts.length === 0 ? (
            ...
            >
              <Card sx={{ p: 4, ...getGlassStyles('subtle', mode), textAlign: 'center' }}>
