    ...
    setAiInsights([
      {
        ...
        message:
          'Peak productivity hours are 10-2 PM. Consider shifting high-value jobs to these slots.',
        impact: 'High',
        confidence: 92,
        icon: <AttachMoney />,
      },
      {
        ...
        message:
          'Parts delivery delays account for 23% of cycle time increases. Recommend inventory optimization.',
        impact: 'Medium',
        confidence: 87,
        icon: <Speed />,
      },
      {
        ...
        message:
          'Customer satisfaction correlation with technician experience shows 94% accuracy.',
        impact: 'Low',
        confidence: 95,
        icon: <EmojiEvents />,
      },
    ...
    setAlerts([
      {
        id: 1,
        type: 'warning',
        title: '2 Jobs Approaching Deadline',
        count: 2,
      },
                      ...
                      <LinearProgress
                        ...
                        sx={{
                          ...
                          '& .MuiLinearProgress-bar': {
                            borderRadius: 4,
                            background:
                              'linear-gradient(90deg, #10b981, #1e40af)',
                          },
                        }}
                      />
                    </Box>
