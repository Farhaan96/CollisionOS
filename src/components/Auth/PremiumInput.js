...
const PremiumInput = forwardRef(({
  ...
  const getStatusIcon = () => {
    ...
    if (focused && value && !error) return <Warning sx={{ color: '#f59e0b', fontSize: 20 }} />;
    return null;
  };
    ...
    >
      <Box sx={{ mb: 3, position: 'relative' }}>
        <TextField
          ...
          InputProps={{
            startAdornment: icon && (
              <Box sx={{ mr: 1, display: 'flex', alignItems: 'center', color: 'rgba(0,0,0,0.5)' }}>
                {icon}
              </Box>
            ),
            endAdornment: (
          ...
          sx={{
            '& .MuiOutlinedInput-root': {
              ...
              '&:hover': {
                ...
                boxShadow: '0 12px 35px rgba(59, 130, 246, 0.15), 0 0 0 1px rgba(59, 130, 246, 0.2)',
                '&::before': {
                  left: '100%'
                }
              },
              '&.Mui-focused': {
                ...
                boxShadow: '0 16px 45px rgba(59, 130, 246, 0.25), 0 0 0 2px rgba(59, 130, 246, 0.3)',
                '&::before': {
                  left: '100%'
                }
              },
              '&.Mui-error': {
                boxShadow: error ? '0 8px 25px rgba(239, 68, 68, 0.2), 0 0 0 1px rgba(239, 68, 68, 0.3)' : 'none',
            ...
            '& .MuiInputLabel-root': {
              ...
              zIndex: 3,
              position: 'relative',
              transform: focused || value ? 'translate(14px, -9px) scale(0.75)' : 'translate(14px, 20px) scale(1)',
              '&.Mui-focused': {
        ...
        {(helperText || error) && (
          <Fade in timeout={300}>
            <Typography
              variant="caption"
              sx={{
                color: error ? '#ef4444' : success ? '#10b981' : 'rgba(0,0,0,0.6)',
                fontSize: '0.75rem',
                fontWeight: 500,
                mt: 0.5,
                display: 'block',
