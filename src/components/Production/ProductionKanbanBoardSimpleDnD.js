...
const ProductionKanbanBoardSimpleDnD = ({
  jobs = [],
  onJobMove,
  onJobUpdate,
  onJobClick,
  ...
  // Handle job status change with error handling and loading states
            ...
            <FormControl size='small' fullWidth>
              ...
              <Select
                ...
                onChange={e => {
                  ...
                  if (newStatus && newStatus !== job.status && !isMoving) {
                    handleJobStatusChange(job, newStatus);
                  }
                }}
                disabled={isMoving}
                label='Change Stage'
...
export default ProductionKanbanBoardSimpleDnD;
