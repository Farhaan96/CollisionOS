                      ...
                      <Typography
                        ...
                        sx={{
                          ...
                          WebkitBackgroundClip:
                            variant === 'executive' ? 'text' : 'initial',
                          WebkitTextFillColor:
                            variant === 'executive' ? 'transparent' : 'inherit',
                        }}
                      >
                        {currentMessage}
                      </Typography>
                ...
                <motion.div variants={childVariants} style={{ width: '100%' }}>
                      ...
                      >
                        <motion.div
                          style={{
                            ...
                            borderRadius: 3,
                            background:
                              premiumDesignSystem.colors.primary.gradient
                                .default,
                  ...
                  {autoProgress && (
                    ...
                    >
                      Estimated time:{' '}
                      {Math.ceil(
                        ((100 - finalProgress) * progressSpeed) / 1000
                      )}
                      s
                    </Typography>
                  )}
...
export { CollisionOSLogo, DotsLoader };
