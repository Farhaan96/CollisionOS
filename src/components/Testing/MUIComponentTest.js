  ...
  return (
    <Box sx={{ p: 3, maxWidth: 1200, mx: 'auto' }}>
      ...
      <Typography
        ...
        paragraph
      >
        Comprehensive test of all MUI components to verify compatibility and
        rendering
      </Typography>
          ...
          <Card elevation={2}>
            <CardContent>
              ...
              <Stack spacing={2}>
                ...
                <Typography variant='subtitle2'>Theme Information</Typography>
                <Typography variant='body2' color='textSecondary'>
      ...
      >
        ...
        <DialogContent>
          <Typography paragraph>
            This is a test dialog to verify MUI Dialog components work
            correctly.
          </Typography>
      ...
      >
        ...
        <Typography variant='caption' color='textSecondary'>
          MUI Material v{require('@mui/material/package.json').version} | MUI X
          Data Grid v{require('@mui/x-data-grid/package.json').version} | MUI X
          Date Pickers v{require('@mui/x-date-pickers/package.json').version}
        </Typography>
      </Box>
    </Box>
  );
