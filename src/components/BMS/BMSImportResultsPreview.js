        ...
        >
          ...
          >
              ...
              <Box>
                ...
                <Typography variant='caption' color='text.secondary'>
                  {editedData.customer?.name ||
                    `${editedData.customer?.firstName || ''} ${editedData.customer?.lastName || ''}`.trim() ||
                    'No customer data'}
                </Typography>
              </Box>
            </Box>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              {getValidationIcon(
                validationResults.customer?.isValid,
                validationResults.customer?.hasWarnings
              )}
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={e =>
                    handleEdit('customer', 'firstName', e.target.value)
                  }
                  disabled={!editMode}
                  variant='outlined'
                  size='small'
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={e =>
                    handleEdit('customer', 'lastName', e.target.value)
                  }
                  disabled={!editMode}
                  variant='outlined'
                  size='small'
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={e =>
                    handleEdit('customer', 'phone', e.target.value)
                  }
                  disabled={!editMode}
                  variant='outlined'
                  size='small'
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={e =>
                    handleEdit('customer', 'email', e.target.value)
                  }
                  disabled={!editMode}
                  variant='outlined'
                  size='small'
              ...
              <Grid xs={12}>
                <TextField
                  ...
                  onChange={e =>
                    handleEdit('customer', 'address', e.target.value)
                  }
                  disabled={!editMode}
                  variant='outlined'
                  size='small'
              ...
              <Grid xs={12} sm={4}>
                <TextField
                  ...
                  value={
                    editedData.customer?.state ||
                    editedData.customer?.province ||
                    ''
                  }
                  onChange={e =>
                    handleEdit('customer', 'state', e.target.value)
                  }
                  disabled={!editMode}
                  variant='outlined'
                  size='small'
              ...
              <Grid xs={12} sm={4}>
                <TextField
                  ...
                  label='Postal Code'
                  value={
                    editedData.customer?.postalCode ||
                    editedData.customer?.zipCode ||
                    ''
                  }
                  onChange={e =>
                    handleEdit('customer', 'postalCode', e.target.value)
                  }
                  disabled={!editMode}
                  variant='outlined'
                  size='small'
              ...
              <Box sx={{ mt: 2 }}>
                ...
                {validationResults.customer.warnings?.length > 0 && (
                  <Alert severity='warning'>
                    ...
                    <List dense>
                      {validationResults.customer.warnings.map(
                        (warning, idx) => (
                          <ListItem key={idx} disableGutters>
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              <Box>
                ...
                <Typography variant='caption' color='text.secondary'>
                  {`${editedData.vehicle?.year || ''} ${editedData.vehicle?.make || ''} ${editedData.vehicle?.model || ''}`.trim() ||
                    'No vehicle data'}
                </Typography>
              </Box>
            </Box>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              {getValidationIcon(
                validationResults.vehicle?.isValid,
                validationResults.vehicle?.hasWarnings
              )}
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={e =>
                    handleEdit('vehicle', 'licensePlate', e.target.value)
                  }
                  disabled={!editMode}
                  variant='outlined'
                  size='small'
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={e =>
                    handleEdit('vehicle', 'mileage', e.target.value)
                  }
                  disabled={!editMode}
                  variant='outlined'
                  size='small'
              ...
              <Box sx={{ mt: 2 }}>
                ...
                {validationResults.vehicle.warnings?.length > 0 && (
                  <Alert severity='warning'>
                    ...
                    <List dense>
                      {validationResults.vehicle.warnings.map(
                        (warning, idx) => (
                          <ListItem key={idx} disableGutters>
                            <ListItemText primary={warning.message} />
                          </ListItem>
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              <Box>
                ...
                <Typography variant='caption' color='text.secondary'>
                  Claim: {editedData.job?.claimNumber || 'N/A'} • Total:{' '}
                  {formatCurrency(editedData.job?.totalAmount)}
                </Typography>
              </Box>
            </Box>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              {getValidationIcon(
                validationResults.job?.isValid,
                validationResults.job?.hasWarnings
              )}
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={e =>
                    handleEdit('job', 'claimNumber', e.target.value)
                  }
                  disabled={!editMode}
                  variant='outlined'
                  size='small'
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={e =>
                    handleEdit('job', 'policyNumber', e.target.value)
                  }
                  disabled={!editMode}
                  variant='outlined'
                  size='small'
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={e =>
                    handleEdit('job', 'insuranceCompany', e.target.value)
                  }
                  disabled={!editMode}
                  variant='outlined'
                  size='small'
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={e =>
                    handleEdit('job', 'deductible', e.target.value)
                  }
                  disabled={!editMode}
                  variant='outlined'
                  size='small'
            ...
            <Box sx={{ mt: 3 }}>
              ...
              <Grid container spacing={2}>
                {[
                  {
                    label: 'Labor',
                    value: editedData.job?.laborTotal,
                    field: 'laborTotal',
                  },
                  {
                    label: 'Parts',
                    value: editedData.job?.partsTotal,
                    field: 'partsTotal',
                  },
                  {
                    label: 'Materials',
                    value: editedData.job?.materialsTotal,
                    field: 'materialsTotal',
                  },
                  {
                    label: 'Total Amount',
                    value: editedData.job?.totalAmount,
                    field: 'totalAmount',
                  },
                ].map(item => (
                  <Grid xs={6} sm={3} key={item.field}>
                    <Paper
                      sx={{
                        p: 2,
                        textAlign: 'center',
            ...
            >
              ...
              <Stack direction='row' spacing={2}>
                ...
                <Button
                  ...
                  onClick={handleSave}
                  disabled={
                    !confirmSave && validationResults.errors?.length > 0
                  }
                  sx={{
                    borderRadius: '12px',
                    background: `linear-gradient(135deg, ${theme.palette.primary.main}, ${theme.palette.secondary.main})`,
            ...
            <Grid container spacing={3}>
              {[
                ...
                },
                {
                  ...
                  value: Object.values(validationResults).reduce(
                    (sum, v) =>
                      sum + (v.errors?.length || 0) + (v.warnings?.length || 0),
                    0
                  ),
                  icon: Warning,
      ...
      >
        ...
        <DialogContent>
          <Alert severity='info' sx={{ mb: 2 }}>
            This will create new customer, vehicle, and job records in your
            database.
          </Alert>
