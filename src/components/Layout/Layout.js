    ...
    <Box sx={{
      ...
      <AppBar 
        ...
        sx={{
          ...
          borderColor: 'divider',
          pointerEvents: 'auto',
          color: (muiTheme.palette.mode === 'light' ? '#374151' : 'rgba(255, 255, 255, 0.95)'),
        }}
      >
        <Toolbar sx={{ 
          pointerEvents: 'auto',
          ...
          <Typography 
            ...
            sx={{ 
              ...
              fontWeight: 700,
              color: 'primary.main',
              textShadow: (muiTheme.palette.mode === 'light' ? 
                  ...
                  <Button
                    ...
                    sx={{
                      color: isActiveRoute(item.path) 
                        ? 'primary.main' 
                        : (muiTheme.palette.mode === 'light' ? '#374151' : 'rgba(255, 255, 255, 0.85)'),
                      ...
                      '&:hover': {
                        bgcolor: isActiveRoute(item.path) 
                          ...
                          : (muiTheme.palette.mode === 'light' ? 'rgba(0, 0, 0, 0.05)' : 'rgba(255, 255, 255, 0.05)'),
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, ml: 2 }}>
            ...
            <Tooltip title="Notifications">
              <IconButton
                sx={{
                  bgcolor: (muiTheme.palette.mode === 'light' ? 'rgba(30, 64, 175, 0.1)' : 'rgba(255, 255, 255, 0.1)'),
                  color: (muiTheme.palette.mode === 'light' ? '#374151' : 'rgba(255, 255, 255, 0.9)'),
                  '&:hover': { 
                    bgcolor: (muiTheme.palette.mode === 'light' ? 'rgba(30, 64, 175, 0.2)' : 'rgba(255, 255, 255, 0.15)') 
                  }
                }}
              >
                <Notifications />
            ...
            {/* Connection Status */}
            <Chip
              icon={<div style={{ width: 8, height: 8, borderRadius: '50%', backgroundColor: '#10b981' }} />}
              label="Connected"
              size="small"
              sx={{
