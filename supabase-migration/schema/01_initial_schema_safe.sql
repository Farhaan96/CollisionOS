-- ==============================================================
-- CollisionOS Supabase Migration - Initial Schema (SAFE VERSION)
-- File: 01_initial_schema_safe.sql
-- Description: Core tables and basic structure with safe creation
-- ==============================================================
...
-- Create customer enums (only if they don't exist)
DO $$ BEGIN
...
-- Create vehicle enums (only if they don't exist)
DO $$ BEGIN
...
-- Create vendor enums (only if they don't exist)
DO $$ BEGIN
...
-- Create parts enums (only if they don't exist)
DO $$ BEGIN
...
-- Create audit enum (only if it doesn't exist)
DO $$ BEGIN
...
-- Updated_at triggers for all tables (only if they don't exist)
DO $$ BEGIN
