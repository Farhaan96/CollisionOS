...
module.exports = (sequelize) => {
  return sequelize.define('ClaimManagement', {
    id: {
    ...
    policyType: {
      type: DataTypes.ENUM('comprehensive', 'collision', 'liability', 'uninsured_motorist', 'pip', 'other'),
      allowNull: true
    },
    ...
    claimStatus: {
      type: DataTypes.ENUM('pending', 'open', 'under_review', 'approved', 'denied', 'closed', 'subrogation', 'litigation'),
    ...
    deductiblePaidBy: {
      type: DataTypes.ENUM('customer', 'insurance', 'shop', 'waived', 'pending'),
      allowNull: true
    },
    deductibleWaived: {
      type: DataTypes.BOOLEAN,
    ...
    lossType: {
      type: DataTypes.ENUM('collision', 'comprehensive', 'vandalism', 'theft', 'weather', 'fire', 'flood', 'animal', 'other'),
      allowNull: true
    },
    atFaultParty: {
      type: DataTypes.ENUM('insured', 'third_party', 'unknown', 'disputed', 'shared'),
      allowNull: true
    },
    liabilityPercentage: {
      type: DataTypes.INTEGER,
    ...
    subrogationStatus: {
      type: DataTypes.ENUM('none', 'potential', 'initiated', 'in_progress', 'recovered', 'closed'),
      defaultValue: 'none'
    },
    subrogationNotes: {
      type: DataTypes.TEXT,
    ...
    litigationStatus: {
      type: DataTypes.ENUM('none', 'threatened', 'filed', 'settled', 'dismissed'),
      defaultValue: 'none'
    },
