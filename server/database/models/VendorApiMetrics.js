  ...
  return sequelize.define(
    ...
    },
    {
      ...
      indexes: [
        ...
        { fields: ['aggregationPeriod'] },
        { fields: ['environment'] },
        { fields: ['createdAt'] },
        // Composite indexes for common queries
        { fields: ['shopId', 'requestTimestamp'] },
        { fields: ['vendorId', 'requestTimestamp'] },
        { fields: ['vendorId', 'wasSuccessful'] },
        { fields: ['vendorId', 'responseTime'] },
        { fields: ['apiConfigId', 'requestTimestamp'] },
        { fields: ['requestType', 'requestTimestamp'] },
        { fields: ['endpoint', 'requestTimestamp'] },
        { fields: ['wasSuccessful', 'requestTimestamp'] },
        { fields: ['errorType', 'requestTimestamp'] },
        { fields: ['performanceGrade', 'requestTimestamp'] },
        { fields: ['aggregationPeriod', 'periodStart'] },
        { fields: ['aggregationPeriod', 'vendorId', 'periodStart'] },
        // Performance monitoring indexes
        { fields: ['requestTimestamp', 'responseTime'] },
        { fields: ['requestTimestamp', 'wasSuccessful'] },
        { fields: ['requestTimestamp', 'errorType'] },
      ],
    }
  );
};