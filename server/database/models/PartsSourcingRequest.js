  ...
  return sequelize.define(
    ...
    },
    {
      ...
      indexes: [
        ...
        { fields: ['preferredDeliveryDate'] },
        { fields: ['selectedVendorId'] },
        { fields: ['oemPartNumber'] },
        { fields: ['partCategory'] },
        { fields: ['vehicleVin'] },
        { fields: ['vehicleYear', 'vehicleMake', 'vehicleModel'] },
        { fields: ['sourcingStatus', 'priority'] },
        { fields: ['requestedBy'] },
        { fields: ['approvedBy'] },
        { fields: ['createdAt'] },
        // Composite indexes for common queries
        { fields: ['shopId', 'sourcingStatus'] },
        { fields: ['repairOrderId', 'sourcingStatus'] },
        { fields: ['sourcingStatus', 'requestedAt'] },
        { fields: ['priority', 'requestedAt'] },
        { fields: ['customerWaiting', 'requestedAt'] },
        { fields: ['rushOrder', 'requestedAt'] },
      ],
    }
  );
};