      ...
      hooks: {
        beforeCreate: history => {
          ...
          if (history.mileage && history.previousMileage) {
            history.mileageDifference =
              history.mileage - history.previousMileage;
          }

          // Set warranty expiry date based on service date and warranty period
          if (
            history.warrantyProvided &&
            history.warrantyPeriod &&
            history.serviceDate
          ) {
        ...
        beforeUpdate: history => {
          ...
          if (
            (history.changed('warrantyPeriod') ||
              history.changed('serviceDate')) &&
            history.warrantyProvided &&
            history.warrantyPeriod &&
            history.serviceDate
          ) {
          ...
          if (
            history.changed('mileage') ||
            history.changed('previousMileage')
          ) {
            if (history.mileage && history.previousMileage) {
              history.mileageDifference =
                history.mileage - history.previousMileage;
          ...
          if (
            history.changed('followUpRequired') &&
