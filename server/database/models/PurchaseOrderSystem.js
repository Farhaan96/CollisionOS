...
module.exports = (sequelize) => {
  return sequelize.define('PurchaseOrderSystem', {
    id: {
    ...
    poStatus: {
      type: DataTypes.ENUM(
        ...
        'partial_received', 'fully_received', 'cancelled', 'closed', 'disputed'
      ),
      defaultValue: 'draft'
    },
    previousStatus: {
    ...
    deliveryMethod: {
      type: DataTypes.ENUM('pickup', 'delivery', 'ship_ground', 'ship_air', 'ship_overnight', 'courier'),
    ...
    transmissionMethod: {
      type: DataTypes.ENUM('email', 'fax', 'phone', 'portal', 'edi', 'mail', 'hand_delivery'),
      allowNull: true
    },
    sentDate: {
      type: DataTypes.DATE,
    ...
    // Receiving Tracking
    receivingStatus: {
      type: DataTypes.ENUM('not_started', 'partial', 'complete', 'over_received', 'discrepancy'),
    ...
    syncStatus: {
      type: DataTypes.ENUM('not_synced', 'synced', 'sync_error', 'pending_sync'),
