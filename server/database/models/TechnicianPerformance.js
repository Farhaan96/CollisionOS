...
module.exports = (sequelize, Sequelize) => {
  const TechnicianPerformance = sequelize.define(
    ...
    },
    {
      ...
      hooks: {
        beforeCreate: performance => {
          ...
          if (performance.hoursWorked > 0) {
            performance.utilizationRate = (
              (performance.productiveHours / performance.hoursWorked) *
              100
            ).toFixed(2);

            if (performance.laborCostGenerated > 0) {
              performance.costPerHour = (
                performance.laborCostGenerated / performance.hoursWorked
              ).toFixed(2);
            }

            if (performance.revenueGenerated > 0) {
              performance.revenuePerHour = (
                performance.revenueGenerated / performance.hoursWorked
              ).toFixed(2);
            }
          }
          ...
          if (performance.revenueGenerated > 0) {
            performance.profitMargin = (
              (performance.profitGenerated / performance.revenueGenerated) *
              100
            ).toFixed(2);
          }
          ...
          if (performance.stagesCompleted > 0) {
            performance.reworkRate = (
              (performance.reworkCount / performance.stagesCompleted) *
              100
            ).toFixed(2);
          }
          ...
          if (totalDays > 0) {
            performance.attendanceRate = (
              (performance.daysWorked / totalDays) *
              100
            ).toFixed(2);
          }
          ...
          performance.performanceGrade = calculatePerformanceGrade(
        ...
        beforeUpdate: performance => {
          ...
          if (
            performance.changed('revenueGenerated') ||
            performance.changed('profitGenerated')
          ) {
            if (performance.revenueGenerated > 0) {
              performance.profitMargin = (
                (performance.profitGenerated / performance.revenueGenerated) *
