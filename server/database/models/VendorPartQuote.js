  ...
  return sequelize.define(
    ...
    },
    {
      ...
      indexes: [
        ...
        { fields: ['unitPrice'] },
        { fields: ['leadTimeEstimate'] },
        { fields: ['quoteStatus'] },
        { fields: ['quoteDate'] },
        { fields: ['quoteExpiry'] },
        { fields: ['isSelected'] },
        { fields: ['selectionRank'] },
        { fields: ['overallScore'] },
        { fields: ['qualityScore'] },
        { fields: ['competitiveRanking'] },
        { fields: ['apiSource'] },
        { fields: ['createdAt'] },
        // Composite indexes for common queries
        { fields: ['sourcingRequestId', 'quoteStatus'] },
        { fields: ['sourcingRequestId', 'unitPrice'] },
        { fields: ['sourcingRequestId', 'leadTimeEstimate'] },
        { fields: ['sourcingRequestId', 'overallScore'] },
        { fields: ['vendorId', 'quoteDate'] },
        { fields: ['vendorId', 'unitPrice'] },
        { fields: ['vendorId', 'availabilityStatus'] },
        { fields: ['partNumber', 'brandType'] },
        { fields: ['isSelected', 'quoteDate'] },
        { fields: ['quoteStatus', 'quoteExpiry'] },
        { fields: ['unitPrice', 'leadTimeEstimate'] },
        { fields: ['overallScore', 'quoteDate'] },
      ],
    }
  );
};